...
int main(){
    Customer A1("faiz", 1, 1000, 24);  // this is abstraction
    Customer A2("umair", 2, 1200, 24);   // this is abstraction


    A1.updateAge(23);// this is abstraction
    A1.display();   // this is abstraction
    A2.display();  // this is abstraction
    cout << pow(2, 3); // this is abstraction
